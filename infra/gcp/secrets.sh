...
#
#  Script to update secrets for arcane-web-proxy to GCP cloud run.
#
...
gcp_secrets[0, "name"]="prerender_token"
gcp_secrets[0, "src"]="secrets/prerender-token.txt"
gcp_secrets[0, "target"]="PRERENDER_TOKEN"
...
CLOUD_RUN_SERVICE="arcane-web-proxy"
